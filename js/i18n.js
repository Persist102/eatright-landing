...
const TRANSLATIONS = {
  uz: {
    ...
    sec1_p: "Ovqat rasmini yuklang yoki kamera bilan suratga oling. Claude AI kaloriya, oqsil, yog', uglevodlarni bir zumda avtomatik aniqlaydi.",
    sec1_btn: "Skanerlash →",
  ...
  ru: {
    ...
    sec1_p: "Загрузите фото еды или снимите камерой. Claude AI автоматически определит калории, белки, жиры и углеводы за секунду.",
  ...
  en: {
    ...
    sec1_p: "Upload a food photo or take one with your camera. Claude AI automatically identifies calories, protein, fat, and carbs instantly.",
    sec1_btn: "Scan now →",
